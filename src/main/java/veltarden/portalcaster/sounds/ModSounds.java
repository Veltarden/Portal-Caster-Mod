package veltarden.portalcaster.sounds;
...
public class ModSounds {
     ...
     */
    public static final SoundEvent PORTAL_CASTER_CASTS_PORTAL = registerSoundEvent("portal_caster_casts_portal");
    public static final SoundEvent PORTAL_CASTER_FAILS = registerSoundEvent("portal_caster_fails");
    public static final SoundEvent BIOME_THEME = registerSoundEvent("biome_theme");
    ...
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = new Identifier(PortalCaster.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {
        PortalCaster.LOGGER.info("Registering Sounds for " + PortalCaster.MOD_ID);
    }
}